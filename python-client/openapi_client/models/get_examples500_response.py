...
class GetExamples500Response(BaseModel):
    """
    ...
    items: Optional[List[ExampleParentModel]] = Field(default=None, description="Array of objects returned, but API error returns empty array.", alias="Items")
