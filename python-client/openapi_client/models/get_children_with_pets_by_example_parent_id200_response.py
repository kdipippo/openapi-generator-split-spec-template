...
class GetChildrenWithPetsByExampleParentId200Response(BaseModel):
    """
    ...
    items: Optional[List[ExampleChildWithPetModel]] = Field(default=None, description="Array of ExampleChildWithPetModel objects returned.", alias="Items")
