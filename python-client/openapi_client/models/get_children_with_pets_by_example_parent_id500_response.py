...
class GetChildrenWithPetsByExampleParentId500Response(BaseModel):
    """
    ...
    items: Optional[List[ExampleChildWithPetModel]] = Field(default=None, description="Array of ExampleChildWithPetModel objects returned, but API error returns empty array.", alias="Items")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Items": [ExampleChildWithPetModel.from_dict(_item) for _item in obj["Items"]] if obj.get("Items") is not None else None,
            "Count": obj.get("Count")
        })
        return _obj
