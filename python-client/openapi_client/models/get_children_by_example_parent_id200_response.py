...
class GetChildrenByExampleParentId200Response(BaseModel):
    """
    ...
    items: Optional[List[ExampleChildModel]] = Field(default=None, description="Array of ExampleChildModel objects returned.", alias="Items")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Items": [ExampleChildModel.from_dict(_item) for _item in obj["Items"]] if obj.get("Items") is not None else None,
            "Count": obj.get("Count")
        })
        return _obj
