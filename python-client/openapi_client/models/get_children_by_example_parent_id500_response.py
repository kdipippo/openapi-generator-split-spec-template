...
class GetChildrenByExampleParentId500Response(BaseModel):
    """
    ...
    items: Optional[List[ExampleChildModel]] = Field(default=None, description="Array of ExampleChildModel objects returned, but API error returns empty array.", alias="Items")
