...
class GetExampleParentById500Response(BaseModel):
    """
    ...
    parent: Optional[List[ExampleParentModel]] = Field(default=None, description="Array of objects returned, but API error returns empty array.", alias="Parent")
    count: Optional[StrictStr] = Field(default=None, description="Count of objects returned, null if error occured.", alias="Count")
    __properties: ClassVar[List[str]] = ["Message", "Parent", "Count"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in parent (list)
        _items = []
        if self.parent:
            for _item in self.parent:
                if _item:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Parent": [ExampleParentModel.from_dict(_item) for _item in obj["Parent"]] if obj.get("Parent") is not None else None,
            "Count": obj.get("Count")
        })
        return _obj
